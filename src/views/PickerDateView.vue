<template>
    <div class="component component-padding">
        ...
        <br><br>
        <h3>3-2.快速切换-设置可选范围2020.03.12-2020.05.01</h3>
        <PickerDate :date="dateSingleQuickScope" :quickSwitch="true" scope="2020.03.12-2020.05.01" @change="dateChangeSingleQuickScope"/>
        ...
        <br><br>
        <h3>3-2.快速切换-设置可选范围2020.03.12-2020.05.01</h3>
        <PickerDate :date="dateDoubleQuickScope" :range="true" scope="2020.03.12-2020.05.01" :quickSwitch="true" @change="dateChangeDoubleQuickScope"/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                dateSingleQuickScope: '2020.03.20',
                ...
                dateDoubleQuickScope: '2020.01.03 11:20:22-2020.02.28 20:08:30',
        ...
        methods: {
            ...
            dateChangeSingleQuickScope(date) {
                console.log('选择的日期::::', date);
                this.dateSingleQuickScope = date;
            },
            ...
            dateChangeDoubleQuickScope(date) {
                console.log('选择的日期::::', date);
                this.dateDoubleQuickScope = date;
            },

  ...
  >
    <template v-if="type === 'text'">
      ...
      <div class="p-input-box">
        ...
        <input :maxlength="maxLength" :name="name" :autofocus="autofocus" ref="input" v-if="!disabled" type="text" :value="value" @focus="inputFocus" @input="searchInput" @blur="inputBlur" @keypress="inputComplete"/>
      </div>
